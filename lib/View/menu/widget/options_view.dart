                  ...
                  children: [
                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Text('0 \nCompleted \nOrders', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),textAlign:TextAlign.center ,),
                                Text('Rs.0 \nTotal \nProfit' , style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),textAlign:TextAlign.center ,),
                                Text('Rs.0 \nTotal \nBonus' , style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),textAlign:TextAlign.center ,),
                              ],
                            )
                          ],
                        ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          border: Border(
                        bottom:
                            BorderSide(width: 2.0, color: Color(0xffECEDEE)),
                      )),
                      child: ListTile(
                    ...
                    Container(
                      ...
                      child: ListTile(
                        ...
                        title: Text(('Payment MEthod Add Krein'),
                            // style: rubikMedium.copyWith(
                            //     fontSize: Dimensions.FONT_SIZE_LARGE)
                        ),
                      ),
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(left: 25.0),
                          child: Text('Help & Support', style: TextStyle(fontWeight: FontWeight.bold , color: Colors.blueGrey), ),
                        ),
                      ],
                    ),
                    SizedBox(height: 10,),
