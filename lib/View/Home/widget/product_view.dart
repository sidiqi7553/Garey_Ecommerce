...
import 'package:garey_ecom/helper/product_type.dart';
...
class _ProductViewState extends State<ProductView> {
  ...
  Widget build(BuildContext context) {
    ...
    //     }
        ...
        //     child: (
        // // Provider.of<ProductProvider>(context, listen: false).offset == pageSize) ? SizedBox() :
        // SizedBox(
        //       width: 300,
        //       child: InkWell(
        //         onTap: (){
        ...
        //             child: Center(child: Text('see_more', style: rubikMedium.copyWith(fontSize: Dimensions.FONT_SIZE_OVER_LARGE))),
        //           ),
        //         ),
        //       ),
        //     ),
