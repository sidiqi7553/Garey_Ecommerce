...
import 'package:garey_ecom/View/product/widget/product_image_view.dart';
import 'package:garey_ecom/View/product/widget/product_title_view.dart';
...
class ProductDetailsScreen extends StatelessWidget {
  ...
  //   //@required this.product, this.cart
  // });
  ...
  Widget build(BuildContext context) {
    ...
    //             child: Text('no_description_found',
    //                 style: TextStyle(
    //                     fontSize: 16)))
    ...
    //             ? Center(child: Text('no_review_found',
    //             style: TextStyle(
    //                 fontSize:  16)))
    //             :
    //         Column(
                ...
                child: SizedBox(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Idhar description likh lena jb api se connect karain gai abhi lay liye is ko aise hi chor do or agay ki screens bnao samajh ayi hai',
                          style: rubikRegular,
                        ),
                        SizedBox(height: 30,),
                        Text(
